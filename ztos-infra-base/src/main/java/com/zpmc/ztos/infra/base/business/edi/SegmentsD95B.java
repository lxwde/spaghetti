...
public class SegmentsD95B {
    ...
    protected List createUNBRules() {
        ...
        EdiRule ruleUNB2 = new EdiRule("UNB_2", "UNB", new Integer(1), new Integer(1), new Integer(1), new Integer(1), new Integer(1), new Integer(1), "2");
    ...
    protected List createCNTRules() {
        ArrayList<EdiRule> cntRules = new ArrayList<EdiRule>();
        EdiRule ruleCNT1 = new EdiRule("CNT_1", "CNT", new Integer(1), new Integer(1), new Integer(0), new Integer(1), new Integer(3), new Integer(1), null);
        cntRules.add(ruleCNT1);
        EdiRule ruleCNT2 = new EdiRule("CNT_2", "CNT", new Integer(1), new Integer(1), new Integer(1), new Integer(1), new Integer(18), new Integer(1), null);
        cntRules.add(ruleCNT2);
        return cntRules;
    }
