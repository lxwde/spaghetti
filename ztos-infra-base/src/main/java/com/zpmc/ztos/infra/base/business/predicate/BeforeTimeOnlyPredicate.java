...
public class BeforeTimeOnlyPredicate extends TimeOnlyPredicate {
    private static final Logger LOGGER = Logger.getLogger(BeforeTimeOnlyPredicate.class);

    BeforeTimeOnlyPredicate(IMetafieldId inFieldId, @Nullable Object inValue, TimeZone inTimeZone) {
