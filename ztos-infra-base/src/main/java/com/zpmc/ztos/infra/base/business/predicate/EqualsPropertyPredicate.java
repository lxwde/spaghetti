...
public class EqualsPropertyPredicate extends GeometryPropertyPredicate{

    public EqualsPropertyPredicate(IMetafieldId inFieldId, IMetafieldId inOtherFieldId) {
