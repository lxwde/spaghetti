...
public abstract class AbstractSimplePredicate extends AbstractFieldPredicate {
    private final Object _fieldValue;

    public AbstractSimplePredicate(IMetafieldId inFieldId, Object inFieldValue) {
        super(inFieldId);
        this._fieldValue = inFieldValue;
    }

    @Deprecated
    AbstractSimplePredicate(String inFieldId, Object inFieldValue) {
