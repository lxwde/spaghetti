...
public class SegmentsAnsi004010 {
    ...
    protected List createR4Rules() {
        ...
        EdiRule ruleR41 = new EdiRule("R4_1", "R4", new Integer(1), new Integer(1), null, new Integer(1), new Integer(1), new Integer(1), null);
        r4Rules.add(ruleR41);
        EdiRule ruleR42 = new EdiRule("R4_2", "R4", new Integer(1), new Integer(2), null, new Integer(1), new Integer(2), new Integer(1), null);
        r4Rules.add(ruleR42);
        EdiRule ruleR43 = new EdiRule("R4_3", "R4", new Integer(1), new Integer(3), null, new Integer(1), new Integer(30), new Integer(1), null);
        r4Rules.add(ruleR43);
        EdiRule ruleR44 = new EdiRule("R4_4", "R4", new Integer(1), new Integer(4), null, new Integer(2), new Integer(24), new Integer(1), null);
        r4Rules.add(ruleR44);
        return r4Rules;
    }
    ...
    protected List createV1Rules() {
        ArrayList v1Rules = new ArrayList();
        return v1Rules;
    }
