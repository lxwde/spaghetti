...
@RestController
@RequestMapping("/api/dummyredis-kafka")
public class DummyredisKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DummyredisKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DummyredisKafkaResource(KafkaProperties kafkaProperties) {
