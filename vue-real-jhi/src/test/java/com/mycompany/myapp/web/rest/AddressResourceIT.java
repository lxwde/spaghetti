...
class AddressResourceIT {
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().detail(DEFAULT_ADDRESS_DETAIL);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().detail(UPDATED_ADDRESS_DETAIL);
        return address;
    }
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getDetail()).isEqualTo(DEFAULT_ADDRESS_DETAIL);
    }
    ...
    void getAllAddresss() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.[*].detail").value(hasItem(DEFAULT_ADDRESS_DETAIL)));
    }
    ...
    void getAddress() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.detail").value(DEFAULT_ADDRESS_DETAIL));
    }
    ...
    void putNewAddress() throws Exception {
        ...
        updatedAddress.detail(UPDATED_ADDRESS_DETAIL);
        ...
        Address testAddress = addressList.get(addressList.size() - 1);
        assertThat(testAddress.getDetail()).isEqualTo(UPDATED_ADDRESS_DETAIL);
    }
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.detail(UPDATED_ADDRESS_DETAIL);
