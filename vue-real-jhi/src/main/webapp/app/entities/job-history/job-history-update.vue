  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="vuerealApp.jobHistory.home.createOrEditLabel"
          data-cy="JobHistoryCreateUpdateHeading"
          v-text="$t('vuerealApp.jobHistory.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.jobHistory.startDate')" for="job-history-startDate">Start Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.jobHistory.endDate')" for="job-history-endDate">End Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.jobHistory.job')" for="job-history-job">Job</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.jobHistory.department')" for="job-history-department"
              >Department</label
            >
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.jobHistory.employee')" for="job-history-employee">Employee</label>
