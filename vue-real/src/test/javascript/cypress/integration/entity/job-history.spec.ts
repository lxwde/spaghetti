...
describe('JobHistory e2e test', () => {
  ...
  it('should create an instance of JobHistory', () => {
    ...
    cy.get(`[data-cy="startDate"]`).type('2022-01-14T08:53').should('have.value', '2022-01-14T08:53');

    cy.get(`[data-cy="endDate"]`).type('2022-01-13T23:02').should('have.value', '2022-01-13T23:02');
