  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="vuerealApp.job.home.createOrEditLabel"
          data-cy="JobCreateUpdateHeading"
          v-text="$t('vuerealApp.job.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.job.jobTitle')" for="job-jobTitle">Job Title</label>
            <input
              type="text"
              class="form-control"
              name="jobTitle"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.job.minSalary')" for="job-minSalary">Min Salary</label>
            <input
              type="number"
              class="form-control"
              name="minSalary"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.job.maxSalary')" for="job-maxSalary">Max Salary</label>
            <input
              type="number"
              class="form-control"
              name="maxSalary"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.job.employee')" for="job-employee">Employee</label>
