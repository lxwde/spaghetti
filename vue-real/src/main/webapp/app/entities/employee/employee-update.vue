  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="vuerealApp.employee.home.createOrEditLabel"
          data-cy="EmployeeCreateUpdateHeading"
          v-text="$t('vuerealApp.employee.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.employee.firstName')" for="employee-firstName">First Name</label>
            <input
              type="text"
              class="form-control"
              name="firstName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.employee.lastName')" for="employee-lastName">Last Name</label>
            <input
              type="text"
              class="form-control"
              name="lastName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.employee.email')" for="employee-email">Email</label>
            <input
              type="text"
              class="form-control"
              name="email"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.employee.phoneNumber')" for="employee-phoneNumber">Phone Number</label>
            <input
              type="text"
              class="form-control"
              name="phoneNumber"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.employee.hireDate')" for="employee-hireDate">Hire Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.employee.salary')" for="employee-salary">Salary</label>
            <input
              type="number"
              class="form-control"
              name="salary"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.employee.commissionPct')" for="employee-commissionPct"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.employee.manager')" for="employee-manager">Manager</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('vuerealApp.employee.department')" for="employee-department">Department</label>
