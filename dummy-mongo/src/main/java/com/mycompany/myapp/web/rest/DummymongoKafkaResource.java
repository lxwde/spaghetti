...
@RestController
@RequestMapping("/api/dummymongo-kafka")
public class DummymongoKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DummymongoKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DummymongoKafkaResource(KafkaProperties kafkaProperties) {
